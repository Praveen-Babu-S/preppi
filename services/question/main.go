...
func main() {
	...
	pb.RegisterQuestionServiceServer(grpcServer, h)
	reflection.Register(grpcServer)

	log.Info().Int("port", port).Msg("question service starting")
