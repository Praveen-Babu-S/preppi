...
import (
	...
	"preppi.com/services/analytics/handler"
...
func main() {
	...
	log.Info().Str("service", "analytics").Int("port", cfg.GRPCPort).Str("logLevel", cfg.LogLevel).Msg("starting service")
	...
	pb.RegisterAnalyticsServiceServer(grpcServer, h)
	reflection.Register(grpcServer)

	log.Info().Int("port", port).Msg("analytics service starting")
